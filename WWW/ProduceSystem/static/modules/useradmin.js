...
; layui.define(["table", "form"], function (e) {
    ...
    i.render({
        ...
        { field: "用户类型", title: "用户类型", minWidth: 100 },
        ...
        i.on("tool(LAY-user-back-manage)", function (e) {
            ...
            if ("del" === e.event) layer.prompt({ formType: 1, title: "敏感操作，请验证口令" },
                ...
                layer.open({
                    ...
                    area: ["420px", "420px"], btn: ["确定", "取消"],
                    yes: function (e, t) { var l = window["layui-layer-iframe" + e], r = "LAY-user-back-submit", n = t.find("iframe").contents().find("#" + r); l.layui.form.on("submit(" + r + ")", function (t) { t.field; i.reload("LAY-user-front-submit"), layer.close(e) }), n.trigger("click") }, success: function (e, t) { }
                })
            }
