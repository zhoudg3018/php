    ...
    function initExpandedListener() {
      ...
      $("." + getOpenClickClass(options.elem, true))
          ...
          .click(function (e) {
            ...
            this.addTR = $([
              "<tr id ='tr"+ itemIndex+"'><td class='opTable-open-td'  colspan='" + (colArr.length + (options.isAloneColumn ? 1 : 0)) + "'>"
